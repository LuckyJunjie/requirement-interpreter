...
export const Diagnostics = {
    ...
    Feature_expected: { code: 1007, message: "Feature expected." } as Diagnostic,
    ...
    Feature_0_does_not_have_a_parameter_named_1_: { code: 2004, message: "Feature '{0}' does not have a parameter named '{1}'." } as Diagnostic,
    Feature_0_is_missing_parameter_1_All_definitions_of_Feature_0_must_specify_the_same_formal_parameters: { code: 2006, message: "Feature '{0}' is missing parameter '{1}'. All definitions of Feature '{0}' must specify the same formal parameters." } as Diagnostic,
